...
export REPORT_DIR="/lustre/scratch126/humgen/teams/hgi/lurge/$INSTANCE"
...
# i.e. 5 volumes (117, 118, 119, 123, 124, 125, 126), 6 workers per volume = 50 cores
NUM_CPUs=50
...
bsub \
    ...
    -G hgi \
    -R "select[mem>5000] rusage[mem=5000]" -M 5000 -n $NUM_CPUs \
