...
History = T.DefaultDict[T.Tuple[T.Union[str, None], str], T.List[T.Tuple[datetime.date, int]]]
...
def get_all_historical_usage_data(conn: mysql.connector.MySQLConnection) -> History:
    ...
    history_results: T.Iterable[T.Tuple[int, datetime.date, str, str]] = cursor.fetchall()
